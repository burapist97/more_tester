...
def ayarlar():
    try:
        print('--- AYARLAR BAŞLADI ---')
        print('Adım: ayarlara tıkla (Tıkla)...')
        ...
        time.sleep(1)
        print('Adım: ses ayarlarına tıkla (Tıkla)...')
        akilli_element_bulucu(driver, r'''//android.widget.TextView[@resource-id="com.token.v1.os.launcher:id/sound_tv_name"]''').click()
        time.sleep(1)
        print('Adım: ses kısma (Tıkla)...')
        driver.tap([(220, 240)])
        time.sleep(1)
        send_run_event('ayarlar', 'Passed')
    except Exception as e:
        print(f'Hata: {e}')
        send_run_event('ayarlar', 'Failed')
...
# --- IDE_METADATA_START ---
# {"platform": "Android", "app_pkg": "", "app_act": "", "bundle_id": "com.apple.Preferences", "cases": [{"name": "ayarlar", "steps": [{"step_name": "ayarlara t\u0131kla", "action": "T\u0131kla", "xpath": "//android.widget.TextView[@resource-id=\"com.token.v1.os.launcher:id/tv_name\" and @text=\"Cihaz ayarlar\u0131\"]", "val": "", "count": 1, "direction": "A\u015fa\u011f\u0131", "x": 0, "y": 0, "sys_key": "Geri"}, {"step_name": "ses ayarlar\u0131na t\u0131kla", "action": "T\u0131kla", "xpath": "//android.widget.TextView[@resource-id=\"com.token.v1.os.launcher:id/sound_tv_name\"]", "val": "", "count": 1, "direction": "A\u015fa\u011f\u0131", "x": 0, "y": 0, "sys_key": "Geri"}, {"step_name": "ses k\u0131sma", "action": "T\u0131kla", "xpath": "", "val": "", "count": 1, "direction": "A\u015fa\u011f\u0131", "x": 220, "y": 240, "sys_key": "Geri"}]}]}
